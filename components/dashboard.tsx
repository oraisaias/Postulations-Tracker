  ...
  return (
    <div className="space-y-8">
      <div className="flex justify-between items-center">
        ...
        {/* Removed the New Application button from here */}
      </div>

      <StatusSummary applications={applications} />

      <Card className="shadow-card border-0 dark:bg-gray-800">
        ...
        <CardContent>
          {isLoading ? (
            ...
            <div className="text-center py-12 px-4">
              <div className="bg-primary-50 dark:bg-gray-700 rounded-full h-16 w-16 flex items-center justify-center mx-auto mb-4">
